    ...
    return this.http
      ...
      .pipe(
        _observableCatch((response_: any) => {
          ...
          } else return <Observable<PaginatedListOfTodoItemDto>>(<any>_observableThrow(response_));
        })
      );
  }
  ...
  init(_data?: any) {
    if (_data) {
      if (Array.isArray(_data['priorityLevels'])) {
        ...
        for (let item of _data['priorityLevels']) this.priorityLevels!.push(PriorityLevelDto.fromJS(item));
      }
